...
def audit(root:pathlib.Path, game:str):
    ...
    checks += [
      ...
      check('sensor_landscape',has(pg,
            r'display/window/handheld/orientation\s*=\s*3\b',
            r'window/handheld/orientation\s*=\s*3\b',
            r'handheld/orientation\s*=\s*3\b',
            r'handheld/orientation.*sensor.*landscape',
            r'orientation.*sensor.*landscape'),
            'sensor-landscape mobile orientation contract'),
      check('expandable_aspect',has(pg,
            r'display/window/stretch/aspect\s*=\s*"?expand"?',
            r'window/stretch/aspect\s*=\s*"?expand"?',
            r'stretch/aspect\s*=\s*"?expand"?',
            r'stretch/aspect.*expand'),
            'expandable aspect contract'),
      check('no_desktop_window_override',not has(pg,
            r'display/window/size/window_width_override\s*=\s*[1-9]',
            r'display/window/size/window_height_override\s*=\s*[1-9]',
            r'window/size/window_width_override\s*=\s*[1-9]',
            r'window/size/window_height_override\s*=\s*[1-9]',
            r'size/window_width_override\s*=\s*[1-9]',
            r'size/window_height_override\s*=\s*[1-9]'),
            'no non-zero desktop window override'),
